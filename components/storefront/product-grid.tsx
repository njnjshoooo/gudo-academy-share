  ...
  return (
    <Link href={`/product/${product.slug}`} className="group">
      <div className="bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-sky-200 hover:shadow-md transition-all duration-200">
        {/* Image */}
        <div className="relative aspect-[4/3] overflow-hidden bg-gradient-to-br from-sky-50 to-blue-100">
          {/* Placeholder gradient (replace with actual Image when images are available) */}
